  ...
  return (
    <div className="flex flex-col w-full h-full bg-gray-50 text-gray-900 relative overflow-hidden">
      ...
      <main className="flex flex-1 overflow-hidden">
        <aside className="w-72 bg-white border-r p-4 overflow-y-auto shrink-0"><InputPanel /></aside>
        <section className="flex-1 relative bg-gray-100 min-w-0"><FlowSandbox /></section>
        <aside className="w-80 bg-white border-l p-4 overflow-y-auto shrink-0"><ForecastPanel /></aside>
      </main>
    </div>
  );
}